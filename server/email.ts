...
export async function sendWelcomeEmail(email: string, firstName: string) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: "Revanth from Pourfolio <onboarding@resend.dev>",
      to: email,
      subject: "Welcome to Pourfolio — Your Liquid Adventures Await",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
          <p>Hi ${userName},</p>
          
          <p>Welcome to Pourfolio — and congratulations on making the responsible choice to track your… let's call them "liquid adventures."</p>
          
          <p>I'm Revanth, the founder of Pourfolio.<br>
          ...
          <p><strong>Here's what you can do inside Pourfolio starting right now:</strong></p>
          ...
          <p>Whether you're a whiskey lover, cocktail explorer, wine romantic, or tequila survivor — Pourfolio makes sure your taste journey is remembered even if you're not.</p>
